...
export default function Footer(){
    return(
        <>
            <div className="font-notosefif bg-[url('/top/inner005.jpg')] bg-auto bg-center ">
                <div className='backdrop-brightness-[0.2] py-[30px]  w-full text-center   text-sm  md:hidden'>
